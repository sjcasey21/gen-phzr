(ns phzr.tilemaps.image-collection
...
(defn ->ImageCollection
  ...
  ([name firstgid]
   (js/Phaser.Tilemaps.ImageCollection. (clj->phaser name)
                                        (clj->phaser firstgid)))
  ([name firstgid width]
   (js/Phaser.Tilemaps.ImageCollection. (clj->phaser name)
                                        (clj->phaser firstgid)
...
(defn add-image
  ...
  Parameters:
    * image-collection (Phaser.Tilemaps.ImageCollection) - Targeted instance for method
