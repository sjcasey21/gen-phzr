(ns phzr.renderer.webgl.pipelines.texture-tint-pipeline
  (:require [phzr.impl.utils.core :refer [clj->phaser phaser->clj]]
            [phzr.impl.extend :as ex]
            [cljsjs.phaser])
  (:refer-clojure :exclude [flush]))

(defn ->TextureTintPipeline
  "  Parameters:
    * config (object) - The configuration options for this Texture Tint Pipeline, as described above."
  ([config]
   (js/Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline. (clj->phaser config))))

(defn add-attribute
  "Adds a description of vertex attribute to the pipeline

  Parameters:
    * texture-tint-pipeline (Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline) - Targeted instance for method
  ...
  ([texture-tint-pipeline name size type normalized offset]
   (phaser->clj
    (.addAttribute texture-tint-pipeline
                   (clj->phaser name)
                   (clj->phaser size)
                   (clj->phaser type)
...
(defn batch-fill-path
  ...
  ([texture-tint-pipeline path current-matrix parent-matrix]
   (phaser->clj
    (.batchFillPath texture-tint-pipeline
                    (clj->phaser path)
...
(defn batch-fill-rect
  ...
  Parameters:
    ...
    * current-matrix (Phaser.GameObjects.Components.TransformMatrix) - The current transform.
    * parent-matrix (Phaser.GameObjects.Components.TransformMatrix) - The parent transform."
  ([texture-tint-pipeline x y width height current-matrix parent-matrix]
   (phaser->clj
    (.batchFillRect texture-tint-pipeline
                    (clj->phaser x)
                    (clj->phaser y)
                    (clj->phaser width)
                    (clj->phaser height)
...
(defn batch-fill-triangle
  ...
  Parameters:
    ...
    * current-matrix (Phaser.GameObjects.Components.TransformMatrix) - The current transform.
    * parent-matrix (Phaser.GameObjects.Components.TransformMatrix) - The parent transform."
  ([texture-tint-pipeline x-0 y-0 x-1 y-1 x-2 y-2 current-matrix parent-matrix]
   (phaser->clj
    (.batchFillTriangle texture-tint-pipeline
                        (clj->phaser x-0)
                        (clj->phaser y-0)
                        (clj->phaser x-1)
                        (clj->phaser y-1)
...
(defn batch-line
  ...
  ([texture-tint-pipeline ax ay bx by a-line-width b-line-width current-matrix]
   (phaser->clj
    (.batchLine texture-tint-pipeline
                (clj->phaser ax)
                (clj->phaser ay)
                (clj->phaser bx)
                (clj->phaser by)
...
(defn batch-quad
  ...
  ([texture-tint-pipeline x-0 y-0 x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-br tint-effect]
   (phaser->clj
    (.batchQuad texture-tint-pipeline
                (clj->phaser x-0)
                (clj->phaser y-0)
                (clj->phaser x-1)
                (clj->phaser y-1)
  ...
  ([texture-tint-pipeline x-0 y-0 x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-br tint-effect texture]
   (phaser->clj
    (.batchQuad texture-tint-pipeline
                (clj->phaser x-0)
                (clj->phaser y-0)
                ...
                (clj->phaser tint-effect)
                (clj->phaser texture))))
  ([texture-tint-pipeline x-0 y-0 x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-br tint-effect texture unit]
   (phaser->clj
    (.batchQuad texture-tint-pipeline
                (clj->phaser x-0)
                (clj->phaser y-0)
...
(defn batch-sprite
  ...
  Parameters:
    * texture-tint-pipeline (Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline) - Targeted instance for method
    * sprite (Phaser.GameObjects.Image | Phaser.GameObjects.Sprite) - The texture based Game Object to add to the batch.
  ...
  ([texture-tint-pipeline sprite camera]
   (phaser->clj
    (.batchSprite texture-tint-pipeline
                  (clj->phaser sprite)
                  (clj->phaser camera))))
  ([texture-tint-pipeline sprite camera parent-transform-matrix]
   (phaser->clj
    (.batchSprite texture-tint-pipeline
                  (clj->phaser sprite)
                  (clj->phaser camera)
...
(defn batch-stroke-path
  ...
  Parameters:
    ...
    * current-matrix (Phaser.GameObjects.Components.TransformMatrix) - The current transform.
    * parent-matrix (Phaser.GameObjects.Components.TransformMatrix) - The parent transform."
  ([texture-tint-pipeline path line-width path-open current-matrix parent-matrix]
   (phaser->clj
    (.batchStrokePath texture-tint-pipeline
                      (clj->phaser path)
...
(defn batch-stroke-triangle
  ...
  Parameters:
    ...
    * current-matrix (Phaser.GameObjects.Components.TransformMatrix) - The current transform.
    * parent-matrix (Phaser.GameObjects.Components.TransformMatrix) - The parent transform."
  ([texture-tint-pipeline x-0 y-0 x-1 y-1 x-2 y-2 line-width current-matrix parent-matrix]
   (phaser->clj
    (.batchStrokeTriangle texture-tint-pipeline
                          (clj->phaser x-0)
                          (clj->phaser y-0)
                          (clj->phaser x-1)
                          (clj->phaser y-1)
...
(defn batch-texture
  ...
  Parameters:
    ...
    * tint-effect (number) - The tint effect.
    ...
    * skip-flip (boolean) {optional} - Skip the renderTexture check."
  ([texture-tint-pipeline game-object texture texture-width texture-height src-x src-y src-width src-height scale-x scale-y rotation flip-x flip-y scroll-factor-x scroll-factor-y display-origin-x display-origin-y frame-x frame-y frame-width frame-height tint-tl tint-tr tint-bl tint-br tint-effect u-offset v-offset camera parent-transform-matrix]
   (phaser->clj
    (.batchTexture texture-tint-pipeline
                   ...
                   (clj->phaser camera)
                   (clj->phaser parent-transform-matrix))))
  ([texture-tint-pipeline game-object texture texture-width texture-height src-x src-y src-width src-height scale-x scale-y rotation flip-x flip-y scroll-factor-x scroll-factor-y display-origin-x display-origin-y frame-x frame-y frame-width frame-height tint-tl tint-tr tint-bl tint-br tint-effect u-offset v-offset camera parent-transform-matrix skip-flip]
   (phaser->clj
    (.batchTexture texture-tint-pipeline
                   (clj->phaser game-object)
                   (clj->phaser texture)
...
(defn batch-texture-frame
  ...
  ([texture-tint-pipeline frame x y tint alpha transform-matrix]
   (phaser->clj
    (.batchTextureFrame texture-tint-pipeline
                        (clj->phaser frame)
                        (clj->phaser x)
                        (clj->phaser y)
                        (clj->phaser tint)
  ...
  ([texture-tint-pipeline frame x y tint alpha transform-matrix parent-transform-matrix]
   (phaser->clj
    (.batchTextureFrame texture-tint-pipeline
                        (clj->phaser frame)
                        (clj->phaser x)
...
(defn batch-tri
  ...
  Returns:  boolean - `true` if this method caused the batch to flush, otherwise `false`."
  ([texture-tint-pipeline x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-effect]
   (phaser->clj
    (.batchTri texture-tint-pipeline
               (clj->phaser x-1)
               (clj->phaser y-1)
               (clj->phaser x-2)
               (clj->phaser y-2)
               ...
               (clj->phaser tint-bl)
               (clj->phaser tint-effect))))
  ([texture-tint-pipeline x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-effect texture]
   (phaser->clj
    (.batchTri texture-tint-pipeline
               (clj->phaser x-1)
               (clj->phaser y-1)
               ...
               (clj->phaser tint-effect)
               (clj->phaser texture))))
  ([texture-tint-pipeline x-1 y-1 x-2 y-2 x-3 y-3 u-0 v-0 u-1 v-1 tint-tl tint-tr tint-bl tint-effect texture unit]
   (phaser->clj
    (.batchTri texture-tint-pipeline
               (clj->phaser x-1)
               (clj->phaser y-1)
...
(defn draw-fill-rect
  ...
  ([texture-tint-pipeline x y width height color alpha]
   (phaser->clj
    (.drawFillRect texture-tint-pipeline
                   (clj->phaser x)
                   (clj->phaser y)
                   (clj->phaser width)
                   (clj->phaser height)
...
(defn on-post-render
  ...
  ([texture-tint-pipeline]
   (phaser->clj
    (.onPostRender texture-tint-pipeline))))
...
(defn on-pre-render
  ...
  ([texture-tint-pipeline]
   (phaser->clj
    (.onPreRender texture-tint-pipeline))))
...
(defn on-render
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline scene camera]
   (phaser->clj
    (.onRender texture-tint-pipeline
               (clj->phaser scene)
               (clj->phaser camera)))))
...
(defn push-batch
  ...
  ([texture-tint-pipeline texture unit]
   (phaser->clj
    (.pushBatch texture-tint-pipeline
                (clj->phaser texture)
                (clj->phaser unit)))))
...
(defn require-texture-batch
  ...
  ([texture-tint-pipeline texture unit]
   (phaser->clj
    (.requireTextureBatch texture-tint-pipeline
                          (clj->phaser texture)
                          (clj->phaser unit)))))
...
(defn resize
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline width height resolution]
   (phaser->clj
    (.resize texture-tint-pipeline
             (clj->phaser width)
             (clj->phaser height)
...
(defn set-float-1
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name x]
   (phaser->clj
    (.setFloat1 texture-tint-pipeline
                (clj->phaser name)
                (clj->phaser x)))))
...
(defn set-float-1v
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name arr]
   (phaser->clj
    (.setFloat1v texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser arr)))))
...
(defn set-float-2
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name x y]
   (phaser->clj
    (.setFloat2 texture-tint-pipeline
                (clj->phaser name)
                (clj->phaser x)
                (clj->phaser y)))))
...
(defn set-float-2v
  ...
  ([texture-tint-pipeline name arr]
   (phaser->clj
    (.setFloat2v texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser arr)))))
...
(defn set-float-3
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name x y z]
   (phaser->clj
    (.setFloat3 texture-tint-pipeline
                (clj->phaser name)
                (clj->phaser x)
                (clj->phaser y)
                (clj->phaser z)))))
...
(defn set-float-3v
  ...
  ([texture-tint-pipeline name arr]
   (phaser->clj
    (.setFloat3v texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser arr)))))
...
(defn set-float-4
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name x y z w]
   (phaser->clj
    (.setFloat4 texture-tint-pipeline
                (clj->phaser name)
                (clj->phaser x)
                (clj->phaser y)
                (clj->phaser z)
...
(defn set-float-4v
  ...
  ([texture-tint-pipeline name arr]
   (phaser->clj
    (.setFloat4v texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser arr)))))
...
(defn set-matrix-2
  ...
  Returns:  this - This WebGLPipeline instance."
  ([texture-tint-pipeline name transpose matrix]
   (phaser->clj
    (.setMatrix2 texture-tint-pipeline
                 (clj->phaser name)
...
(defn set-matrix-3
  ...
  ([texture-tint-pipeline name transpose matrix]
   (phaser->clj
    (.setMatrix3 texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser transpose)
                 (clj->phaser matrix)))))
...
(defn set-matrix-4
  ...
  ([texture-tint-pipeline name transpose matrix]
   (phaser->clj
    (.setMatrix4 texture-tint-pipeline
                 (clj->phaser name)
                 (clj->phaser transpose)
                 (clj->phaser matrix)))))
...
(defn set-texture-2-d
  ...
  ([texture-tint-pipeline]
   (phaser->clj
    (.setTexture2D texture-tint-pipeline)))
  ([texture-tint-pipeline texture]
   (phaser->clj
    (.setTexture2D texture-tint-pipeline
                   (clj->phaser texture))))
  ([texture-tint-pipeline texture unit]
...
(defn should-flush
  ...
  ([texture-tint-pipeline]
   (phaser->clj
    (.shouldFlush texture-tint-pipeline))))