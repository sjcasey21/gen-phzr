(ns phzr.game-objects.bitmap-text
...
(defn ->BitmapText
  ...
  ([scene x y font]
   (js/Phaser.GameObjects.BitmapText. (clj->phaser scene)
                                      (clj->phaser x)
                                      (clj->phaser y)
                                      (clj->phaser font)))
  ([scene x y font text]
...
(defn add-listener
  ...
  Parameters:
    * bitmap-text (Phaser.GameObjects.BitmapText) - Targeted instance for method
    * event (string | symbol) - The event name.
    * fn (function) - The listener function.
    * context (*) {optional} - The context to invoke the listener with.

  Returns:  Phaser.Events.EventEmitter - `this`."
  ([bitmap-text event fn]
   (phaser->clj
    (.addListener bitmap-text
                  (clj->phaser event)
                  (clj->phaser fn))))
  ([bitmap-text event fn context]
   (phaser->clj
    (.addListener bitmap-text
                  (clj->phaser event)
                  (clj->phaser fn)
...
(defn clear-mask
  ...
  ([bitmap-text]
   (phaser->clj
    (.clearMask bitmap-text)))
  ([bitmap-text destroy-mask]
   (phaser->clj
    (.clearMask bitmap-text
...
(defn create-bitmap-mask
  ...
  ([bitmap-text]
   (phaser->clj
    (.createBitmapMask bitmap-text)))
  ([bitmap-text renderable]
   (phaser->clj
    (.createBitmapMask bitmap-text
...
(defn create-geometry-mask
  ...
  ([bitmap-text]
   (phaser->clj
    (.createGeometryMask bitmap-text)))
...
(defn disable-interactive
  ...
  ([bitmap-text]
   (phaser->clj
    (.disableInteractive bitmap-text))))
...
(defn get-local-transform-matrix
  ...
  ([bitmap-text]
   (phaser->clj
    (.getLocalTransformMatrix bitmap-text)))
  ([bitmap-text temp-matrix]
   (phaser->clj
    (.getLocalTransformMatrix bitmap-text
...
(defn get-world-transform-matrix
  ...
  ([bitmap-text]
   (phaser->clj
    (.getWorldTransformMatrix bitmap-text)))
  ([bitmap-text temp-matrix]
   (phaser->clj
    (.getWorldTransformMatrix bitmap-text
                              (clj->phaser temp-matrix))))
  ([bitmap-text temp-matrix parent-matrix]
   (phaser->clj
    (.getWorldTransformMatrix bitmap-text
                              (clj->phaser temp-matrix)
...
(defn init-pipeline
  ...
  ([bitmap-text]
   (phaser->clj
    (.initPipeline bitmap-text)))
  ([bitmap-text pipeline-name]
   (phaser->clj
    (.initPipeline bitmap-text
  ...
  ([bitmap-text event fn context]
   (phaser->clj
    (.off bitmap-text
          ...
          (clj->phaser fn)
          (clj->phaser context))))
  ([bitmap-text event fn context once]
   (phaser->clj
    (.off bitmap-text
          (clj->phaser event)
          (clj->phaser fn)
...
(defn remove-all-listeners
  ...
  ([bitmap-text]
   (phaser->clj
    (.removeAllListeners bitmap-text)))
  ([bitmap-text event]
   (phaser->clj
    (.removeAllListeners bitmap-text
                         (clj->phaser event)))))
...
(defn set-alpha
  ...
  ([bitmap-text]
   (phaser->clj
    (.setAlpha bitmap-text)))
  ([bitmap-text top-left]
   (phaser->clj
    (.setAlpha bitmap-text
               (clj->phaser top-left))))
  ([bitmap-text top-left top-right]
   (phaser->clj
    (.setAlpha bitmap-text
               (clj->phaser top-left)
               (clj->phaser top-right))))
  ([bitmap-text top-left top-right bottom-left]
   (phaser->clj
    (.setAlpha bitmap-text
               (clj->phaser top-left)
               (clj->phaser top-right)
               (clj->phaser bottom-left))))
  ([bitmap-text top-left top-right bottom-left bottom-right]
   (phaser->clj
    (.setAlpha bitmap-text
               (clj->phaser top-left)
               (clj->phaser top-right)
...
(defn set-font
  ...
  ([bitmap-text font]
   (phaser->clj
    (.setFont bitmap-text
              (clj->phaser font))))
  ([bitmap-text font size]
   (phaser->clj
    (.setFont bitmap-text
              (clj->phaser font)
              (clj->phaser size))))
  ([bitmap-text font size align]
   (phaser->clj
    (.setFont bitmap-text
              (clj->phaser font)
              (clj->phaser size)
...
(defn set-frame
  ...
  ([bitmap-text frame]
   (phaser->clj
    (.setFrame bitmap-text
               (clj->phaser frame))))
  ([bitmap-text frame update-size]
   (phaser->clj
    (.setFrame bitmap-text
               (clj->phaser frame)
               (clj->phaser update-size))))
  ([bitmap-text frame update-size update-origin]
   (phaser->clj
    (.setFrame bitmap-text
               (clj->phaser frame)
               (clj->phaser update-size)
...
(defn set-interactive
  ...
  ([bitmap-text]
   (phaser->clj
    (.setInteractive bitmap-text)))
  ([bitmap-text shape]
   (phaser->clj
    (.setInteractive bitmap-text
                     (clj->phaser shape))))
  ([bitmap-text shape callback]
   (phaser->clj
    (.setInteractive bitmap-text
                     (clj->phaser shape)
                     (clj->phaser callback))))
  ([bitmap-text shape callback drop-zone]
   (phaser->clj
    (.setInteractive bitmap-text
                     (clj->phaser shape)
                     (clj->phaser callback)
...
(defn set-origin-from-frame
  ...
  ([bitmap-text]
   (phaser->clj
    (.setOriginFromFrame bitmap-text))))
  ...
  ([bitmap-text x y]
   (phaser->clj
    (.setRandomPosition bitmap-text
                        (clj->phaser x)
                        (clj->phaser y))))
  ([bitmap-text x y width]
   (phaser->clj
    (.setRandomPosition bitmap-text
                        (clj->phaser x)
                        (clj->phaser y)
                        (clj->phaser width))))
  ([bitmap-text x y width height]
   (phaser->clj
    (.setRandomPosition bitmap-text
                        (clj->phaser x)
                        (clj->phaser y)
...
(defn set-texture
  ...
  ([bitmap-text key]
   (phaser->clj
    (.setTexture bitmap-text
                 (clj->phaser key))))
  ([bitmap-text key frame]
   (phaser->clj
    (.setTexture bitmap-text
                 (clj->phaser key)
                 (clj->phaser frame)))))
...
(defn update-display-origin
  ...
  ([bitmap-text]
   (phaser->clj
    (.updateDisplayOrigin bitmap-text))))
