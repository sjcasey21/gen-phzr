...
(defn ->Arc
  ...
  ([scene]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)))
  ([scene x]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)))
  ([scene x y]
  ...
  ([scene x y radius]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               ...
                               (clj->phaser y)
                               (clj->phaser radius)))
  ([scene x y radius start-angle]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)
                               (clj->phaser y)
                               (clj->phaser radius)
                               (clj->phaser start-angle)))
  ([scene x y radius start-angle end-angle]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)
                               (clj->phaser y)
                               (clj->phaser radius)
  ...
  ([scene x y radius start-angle end-angle anticlockwise]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)
                               (clj->phaser y)
                               (clj->phaser radius)
  ...
  ([scene x y radius start-angle end-angle anticlockwise fill-color]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)
                               (clj->phaser y)
                               (clj->phaser radius)
  ...
  ([scene x y radius start-angle end-angle anticlockwise fill-color fill-alpha]
   (js/Phaser.GameObjects.Arc. (clj->phaser scene)
                               (clj->phaser x)
                               (clj->phaser y)
                               (clj->phaser radius)
...
(defn add-listener
  ...
  Parameters:
    * arc (Phaser.GameObjects.Arc) - Targeted instance for method
...
(defn get-world-transform-matrix
  ...
  ([arc]
   (phaser->clj
    (.getWorldTransformMatrix arc)))
  ([arc temp-matrix]
   (phaser->clj
    (.getWorldTransformMatrix arc
                              (clj->phaser temp-matrix))))
  ([arc temp-matrix parent-matrix]
   (phaser->clj
    (.getWorldTransformMatrix arc
                              (clj->phaser temp-matrix)
...
(defn set-alpha
  ...
  ([arc top-left]
   (phaser->clj
    (.setAlpha arc
               (clj->phaser top-left))))
  ([arc top-left top-right]
   (phaser->clj
    (.setAlpha arc
               (clj->phaser top-left)
               (clj->phaser top-right))))
  ([arc top-left top-right bottom-left]
   (phaser->clj
    (.setAlpha arc
               (clj->phaser top-left)
               (clj->phaser top-right)
               (clj->phaser bottom-left))))
  ([arc top-left top-right bottom-left bottom-right]
   (phaser->clj
    (.setAlpha arc
               (clj->phaser top-left)
               (clj->phaser top-right)
...
(defn set-end-angle
  ...
  Parameters:
    * arc (Phaser.GameObjects.Arc) - Targeted instance for method
    * value (integer) - The value to set the ending angle to.
...
(defn set-iterations
  ...
  Parameters:
    * arc (Phaser.GameObjects.Arc) - Targeted instance for method
    * value (number) - The value to set the iterations to.
...
(defn set-radius
  ...
  Parameters:
    * arc (Phaser.GameObjects.Arc) - Targeted instance for method
    * value (number) - The value to set the radius to.
...
(defn set-start-angle
  ...
  Parameters:
    * arc (Phaser.GameObjects.Arc) - Targeted instance for method
    * value (integer) - The value to set the starting angle to.
...
(defn set-stroke-style
  ...
  ([arc line-width color]
   (phaser->clj
    (.setStrokeStyle arc
                     (clj->phaser line-width)
                     (clj->phaser color))))
  ([arc line-width color alpha]
   (phaser->clj
    (.setStrokeStyle arc
                     (clj->phaser line-width)
                     (clj->phaser color)
