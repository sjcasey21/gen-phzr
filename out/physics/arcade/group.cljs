...
(defn ->Group
  ...
  ([world scene]
   (js/Phaser.Physics.Arcade.Group. (clj->phaser world)
                                    (clj->phaser scene)))
...
(defn add
  ...
  Parameters:
    * group (Phaser.Physics.Arcade.Group) - Targeted instance for method
...
(defn create-callback-handler
  ...
  Parameters:
    * group (Phaser.Physics.Arcade.Group) - Targeted instance for method
    * child (Phaser.GameObjects.GameObject) - The Game Object being added."
  ([group child]
   (phaser->clj
    (.createCallbackHandler group
                            (clj->phaser child)))))
...
(defn remove-callback-handler
  ...
  Parameters:
    * group (Phaser.Physics.Arcade.Group) - Targeted instance for method
    * child (Phaser.GameObjects.GameObject) - The Game Object being removed."
  ([group child]
   (phaser->clj
    (.removeCallbackHandler group
                            (clj->phaser child)))))
...
(defn set-velocity
  ...
  Parameters:
    ...
    * step (number) {optional} - The velocity increment. When set, the first member receives velocity (x, y), the second (x + step, y + step), and so on.
...
(defn set-velocity-x
  ...
  Parameters:
    * group (Phaser.Physics.Arcade.Group) - Targeted instance for method
    * value (number) - The velocity value.
    * step (number) {optional} - The velocity increment. When set, the first member receives velocity (x), the second (x + step), and so on.
...
(defn set-velocity-y
  ...
  Parameters:
    * group (Phaser.Physics.Arcade.Group) - Targeted instance for method
    * value (number) - The velocity value.
    * step (number) {optional} - The velocity increment. When set, the first member receives velocity (y), the second (y + step), and so on.
