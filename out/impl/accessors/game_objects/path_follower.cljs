(ns phzr.impl.accessors.game-objects.path-follower)

(def path-follower-get-properties
  {:active "active"
   :alpha "alpha"
   ...
   :path-rotation-offset "pathRotationOffset"
   :path-tween "pathTween"
   :path-vector "pathVector"
   :pipeline "pipeline"
   :render-flags "renderFlags"
   :rotate-to-path "rotateToPath"
   :rotation "rotation"
   :scale "scale"
   :scale-x "scaleX"
   :scale-y "scaleY"
...
(def path-follower-set-properties
  {:active "active"
   :alpha "alpha"
   :alpha-bottom-left "alphaBottomLeft"
   :alpha-bottom-right "alphaBottomRight"
